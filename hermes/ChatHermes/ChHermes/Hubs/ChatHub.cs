...
namespace ChHermes.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        {
            Clients.All.groupAdded(roomName);
        ...
        public void SendToGroup(string roomName, string message, string name)
        {
        ...
        public void Send(string message)
        {
            ...
            Clients.All.received(new { sender = sender, message = message, isPrivate = false, isGroup = false });
        }
